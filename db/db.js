var peer = new Peer();
var serverID = "lleme-play-server-2"
...
function getRandomDate() {
    ...
    /*     console.log(dateToStr(new Date(new Date().getTime() + ((dayAdjustment + offset) * (1 * (1000 * 60 * 60 * 24)))))) */
    return new Date(new Date().getTime() + ((dayAdjustment + offset) * (1 * (1000 * 60 * 60 * 24))));
}
...
function editUser(userObj) {
    ...
    if (userObj.postal_code1 && userObj.postal_code2) json.users_db[email].postal_code = userObj.postal_code1 + "-" + userObj.postal_code2
    ...
    if (userObj.expiration_date1 && userObj.expiration_date2) json.users_db[email].expiration_date = userObj.expiration_date1 + "/" + userObj.expiration_date2
